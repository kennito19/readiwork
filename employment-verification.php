<?php
/**
 * Readiwork - Kenya Employment Verification
 * Verify employment history using national ID or passport
 */
            ...
            if (!$yv_endpoint) {
                ...
                if ($yv_result && $yv_result['success']) {
                    ...
                    if (!$reference_id) {
                        ...
                        $error = "No employment records found for ID <strong>" . htmlspecialchars($id_number) . "</strong>.";
                        ...
                        try {
                            ...
                            $employment_name = $api_data['employmentName'] ?? null;
                            $last_employment = $api_data['lastEmployment'] ?? null;
                            $gender = $api_data['gender'] ?? null;
                            $marital_status = $api_data['maritalStatus'] ?? null;

                            // Combine employment info for business_name field
                            $employment_info = null;
                            if ($employment_name || $last_employment) {
                                $employment_info = json_encode([
                                    'current' => $employment_name,
                                    'last' => $last_employment
                                ]);
                            }
                            ...
                            $stmt->execute([
                                ...
                                ':dob'      => $dob,
                                ':phone'    => null,
                                ':bname'    => $employment_info,
                                ':addr'     => $gender ? "Gender: $gender" . ($marital_status ? ", Marital: $marital_status" : '') : null,
                    ...
                    if ($http_code === 401) {
                        ...
                        $error = "No employment records found for this ID.";
                        $errorIcon = 'user-slash';
                    } else {
...
<head>
<meta charset="utf-8">
<title>AI Kenya Employment Verification — Readiwork AI</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Verify employment history for Kenyan citizens using official records.">
...
<section class="page-hero">
  <div class="container">
    <h1><i class="fa-solid fa-robot"></i> Kenya <span>Employment</span> Verification<span class="provider-badge provider-youverify">AI + YouVerify</span></h1>
    <p>Verify employment history and current employment status using official records.</p>
  </div>
</section>
        ...
        <div class="row g-5 align-items-stretch">
                ...
                <div class="form-card">
                    ...
                    <form method="POST" id="verificationForm">
                        ...
                        <div class="form-note">
                            ...
                            Your National ID is used strictly for employment verification purposes.
                        </div>
            ...
            <div class="col-lg-5 order-2 order-lg-1">
                <div class="info-card">
                    ...
                    <ul class="info-list">
                        <li><i class="fa-solid fa-check"></i> Current employment verification</li>
                        <li><i class="fa-solid fa-check"></i> Employment history records</li>
                        <li><i class="fa-solid fa-check"></i> Employer name confirmation</li>
