<?php
/**
 * Readiwork - Kenya National ID Verification
 * Simple dedicated page - National ID number ONLY
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['national_id'])) {
    ...
    if (!preg_match('/^\d{7,8}$/', $national_id)) {
        $error = "Invalid National ID format. Use 7-8 digits (e.g. 12345678 or 1234567).";
        $errorIcon = 'exclamation-circle';
    } else {
        try {
            $service_type = 'yv-ke-national-id';
            ...
            if (!$yv_endpoint) {
                ...
                // Build YouVerify request - ID scrub needs ID, consent, and idType
                $yv_data = [
                    'id' => $national_id,
                ...
                if ($yv_result && $yv_result['success']) {
                    ...
                    if (!$reference_id) {
                        ...
                        $error = "National ID <strong>" . htmlspecialchars($national_id) . "</strong> was not found in official records.";
                    ...
                    if ($http_code === 401) {
                        ...
                        $error = "National ID not found in YouVerify database.";
                        $errorIcon = 'user-slash';
                    } else {
...
<head>
<meta charset="utf-8">
<title>AI Kenya National ID Verification — Readiwork AI</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Verify Kenyan national identity card authenticity and validity with official government records.">
...
<section class="page-hero">
  <div class="container">
    <h1><i class="fa-solid fa-robot"></i> Kenya <span>National ID</span> Verification<span class="provider-badge provider-youverify">AI + YouVerify</span></h1>
    <p>Verify Kenyan national identity card authenticity and validity with official government records.</p>
  </div>
</section>
    ...
    <div class="container">
        <div class="row g-5 align-items-stretch">
                    ...
                    <form method="POST" id="verificationForm">
                        <div class="mb-4 form-group">
                            ...
                            <input type="text" name="national_id" id="nationalIdInput" class="form-control"
                                   ...
                                   placeholder="e.g. 12345678 or 1234567" required maxlength="8">
                        </div>

                        <div class="form-note">
                            <i class="fa-solid fa-circle-info"></i>
                            Your National ID is used strictly for verification purposes and handled securely.
                        </div>
            ...
            <div class="col-lg-5 order-2 order-lg-1">
                <div class="info-card">
                    <h4>What this ID check includes</h4>
                    <ul class="info-list">
                        <li><i class="fa-solid fa-check"></i> National ID validation with official government database</li>
                        <li><i class="fa-solid fa-check"></i> Document authenticity & validity confirmation</li>
                        <li><i class="fa-solid fa-check"></i> Holder's full name and date of birth</li>
...
<script>
// Only allow digits in national ID input
